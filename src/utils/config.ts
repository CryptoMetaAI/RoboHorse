...
const flatDirectory: Record<number, string> = {1: '', 5: "0x6d3B3858FDdafd4A3E1d32Cc8930D05EA492A67A"}
...
export {evmChainIds, flatDirectory, fansNFTFactoryAddr, marketFactoryAddr, marketHelperAddr, 
        FullZeroAddr, xenAddr, xNFTAddr, rewardCalculatorAddr, dPoolAddr, chainId2NetworkName, unit, wssUrl, MergeType,
        BroswerScan, getABIUrl, CEXInfo}