...
const chainId2NetworkName: Record<number, string> = {1: 'Ethereum', 10: 'Optimism', 97: 'BSC-Testnet', 42161: 'Arbitrum-One', 80001: 'Mumbai', 42170: 'Arbitrum-Nova'}
const unit: Record<number, string> = {1: 'ETH', 10: 'ETH', 97: 'BNB', 42161: 'ETH', 42170: 'ETH', 80001: 'MATIC', 10001: 'ETHW', 513100: 'ETF'}
